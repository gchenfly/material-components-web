...
`mdc-text-field--ltr-input` | Styles the text field's input as LTR even when the direction is RTL. Useful for RTL languages that use LTR for fractional notations.
